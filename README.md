...
TODO:
#define NOZZLE_TO_PROBE_OFFSET muss korrekt gesetzt werden

#define Z_STEPPER_ALIGN_XY muss korrekt gesetzt werden 

in confiiguration_adv: 

#define Z_STEPPER_ALIGN_XY  müssen die Punkte so gesetzt werden, dass die beiden Punkte auf den hinteren Federn des Betts liegen.
